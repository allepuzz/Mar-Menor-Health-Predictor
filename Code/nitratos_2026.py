...
model = RandomForestRegressor(n_estimators=100, max_depth=10, min_samples_split=5, min_samples_leaf=1, max_features='sqrt', bootstrap=False)
...
plt.plot(fechas_predicciones, future_predictions, label='Predicciones Futuras de Nitratos (hasta finales de 2026)', color='gold')

# Añadir el umbral de 12.9
plt.axhline(y=0.08, color='green', linestyle='--', label='Umbral de Nitratos = 0.08 mg/L')
