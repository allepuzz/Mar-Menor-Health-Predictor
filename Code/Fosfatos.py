...
plt.savefig('./matriz_correlacion_fosfatos.svg', format='svg')
plt.show()
...
plt.title('Comparación de Valores Reales vs. Predichos de Fosfatos')
plt.xlabel('Fecha')
plt.ylabel('Fosfatos')
plt.legend()
plt.grid(True)
plt.savefig('./Fosfatos_prediccion.svg', format='svg')
plt.show()
